...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # put beam_search_results into extra info
            for res_i, res_beam in enumerate(test_output_gen_batch.non_tensor_batch["beam_search_results"]):
                test_batch.non_tensor_batch["extra_info"][res_i]["beam_search_results"] = res_beam
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # put beam_search_results into extra info
                    for res_i, res_beam in enumerate(gen_batch_output.non_tensor_batch["beam_search_results"]):
                        batch.non_tensor_batch["extra_info"][res_i]["beam_search_results"] = res_beam
